# Життєвий цикл компонента. Робота з REST API | goit-react-hw-04-image-finder
...
!!!Проведено рефакторинг коду завдання «Пошук зображень» з третього модуля,
використовуючи React-хуки. Завдання третього модуля:
...
під час сабміту форми. Створює DOM-елемент наступної структури. a
